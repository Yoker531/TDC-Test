...
plt.xlabel("Phi Offset")
plt.ylabel("Popcount")
plt.title("Pico Sweep")
plt.savefig('outputs/pico_sweep.png')
plt.show()

plt.plot(pico_sweep - base_sweep)
plt.xlabel("Phi Offset")
plt.ylabel("Popcount Difference")
plt.title("Popcount Difference with AES Running")
plt.savefig('outputs/popcount_difference.png')
plt.show()